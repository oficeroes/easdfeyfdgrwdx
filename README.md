...
> 📌 详见 [`第二部分选题建议与理由.md`](./第二部分选题建议与理由.md)，内含国际竞赛获奖趋势分析与三套推荐选题方案。
...
│   ├── 2026 團隊賽數據包.xlsx          # 2026 年生物多样性数据（待补充）
...
│
├── 可读文本/                          # 导出的可读文本（由 read_data.py 生成）
├── venv/                              # Python 虚拟环境（已加入 .gitignore）
└── 2026 團隊賽數據包.xlsx             # （待补充）
```
...
> 💡 详细的环境配置说明见 [`Python环境配置说明.md`](./Python环境配置说明.md)
